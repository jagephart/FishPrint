...
write.csv(feed_fp_noland, file.path(datadir, "feed_fp_scenario_7_economic.csv"), row.names = FALSE)
...
write.csv(feed_fp_fish_bp, file.path(datadir, "feed_fp_scenario_2c_economic.csv"), row.names = FALSE)
...
write.csv(feed_fp_fish_low_impact_bp, file.path(datadir, "feed_fp_scenario_2d_economic.csv"), row.names = FALSE)
...
write.csv(feed_fp_fmfo_low_impact_bp, file.path(datadir, "feed_fp_scenario_6_economic.csv"), row.names = FALSE)
