...
- Patrik look into after holiday
- Harvest and yield time dimensions will need to be standardized

2. Fill in feed ingredient FP and protein content values
 - Alon pulled the terrestrial feed data N and P content. Discuss how to calculate the average and distribution based on the 
 - Feed FP data from Rob are now available in Google Sheet tab "Impact factors"
...
6. How to handle Energy_demand column in non-feed ghg function?
...
8. Evaporation
 ...
 - We may want to consider a multiplication factor for losses from aerated ponds
...
# Load feed FP data FIX IT: Replace with Rob's data
